(function () {
  ...
  const tarotQuestionPaths = [
    ...
    { key: "orientation", title: "Upright & Reversed", description: "See the full story through upright and reversed tarot meanings: expression, resistance, balance, delay, and deeper truth.", route: "/tarot/upright-vs-reversed", available: false, regularImage: "/assets/images/background%20_images/upright-reverse.png", bloodMoonImage: "/assets/images/background%20_images/bloodmoon-upright-reverse.png", alt: "Astral Veil artwork representing upright and reversed tarot meanings in balance" }
  ];
  const tarotGuides = [
    { key: "history", eyebrow: "The Chronicle of the Cards", title: "The History of Tarot", description: "Trace tarot from its early life as a European card game through symbolism, divination, reflection, and modern practice.", route: "/tarot/history", available: false, image: "/assets/images/background%20_images/history-of-tarot.png", imageAlt: "A candlelit archive of antique tarot cards, books, and a tall stained-glass window", imageWidth: 1122, imageHeight: 1402, imageAspect: "portrait", imageFit: "cover", objectPosition: "58% center", layoutSize: "featured" },
    ...
    { key: "major-arcana", title: "Major Arcana Explained", description: "Explore the twenty-two archetypes, turning points, and transformations of the Major Arcana.", route: "/tarot/major-arcana", available: false, image: "/assets/images/background%20_images/major-arcana-explained.png", imageAlt: "A cloaked figure standing before a luminous celestial arch", imageWidth: 1448, imageHeight: 1086, imageAspect: "landscape", imageFit: "cover", objectPosition: "70% center", layoutSize: "standard" },
    { key: "minor-arcana", title: "Minor Arcana Explained", description: "Understand the four suits, court cards, numbers, and everyday experiences of the Minor Arcana.", route: "/tarot/minor-arcana", available: false, image: "/assets/images/background%20_images/minor-arcana-explained.png", imageAlt: "Four symbolic tarot cards arranged beside a candle and ritual objects", imageWidth: 1448, imageHeight: 1086, imageAspect: "landscape", imageFit: "cover", objectPosition: "38% 62%", layoutSize: "standard" },
    { key: "spreads", title: "Tarot Spreads", description: "Discover layouts for daily guidance, love, career, reflection, and deeper insight.", route: "/tarot/spreads", available: false, image: "/assets/images/background%20_images/tarot-spreads.png", imageAlt: "Multiple tarot spreads arranged across a candlelit midnight cloth", imageWidth: 1672, imageHeight: 941, imageAspect: "wide", imageFit: "cover", objectPosition: "58% center", layoutSize: "wide" },
    { key: "tarot-vs-oracle", title: "Tarot vs. Oracle Cards", description: "Compare their structures, symbolism, flexibility, and approaches to intuitive reading.", route: "/tarot/tarot-vs-oracle-cards", available: false, image: "/assets/images/background%20_images/tarot-vs-oracle-cards.png", imageAlt: "Tarot and oracle cards arranged together beneath a crescent moon", imageWidth: 1672, imageHeight: 941, imageAspect: "wide", imageFit: "cover", objectPosition: "52% center", layoutSize: "comparison" },
    { key: "tarot-vs-lenormand", title: "Tarot vs. Lenormand", description: "Explore the differences between tarot’s archetypes and Lenormand’s direct symbolic language.", route: "/tarot/tarot-vs-lenormand", available: false, image: "/assets/images/background%20_images/tarot-vs-lenormand.png", imageAlt: "Tarot cards and Lenormand cards arranged side by side on a celestial cloth", imageWidth: 1672, imageHeight: 941, imageAspect: "wide", imageFit: "cover", objectPosition: "58% center", layoutSize: "comparison" }
  ];
  ...
  function renderTarotGuides() {
    ...
    tarotGuidesGrid.innerHTML = tarotGuides.map((guide) => {
      ...
      const content = `<div class="tarot-guide__content">${guide.eyebrow ? `<p class="tarot-guide__eyebrow">${escapeHtml(guide.eyebrow)}</p>` : ""}<h3>${escapeHtml(guide.title)}</h3><p class="tarot-guide__description">${escapeHtml(guide.description)}</p><p class="tarot-guide__status">Coming Soon</p></div>`;
      ...
      return `<article class="tarot-guide tarot-guide--${escapeHtml(guide.layoutSize)}" data-tarot-guide="${escapeHtml(guide.key)}" data-route="${escapeHtml(guide.route)}" data-available="${guide.available}">${guide.available ? `<a class="tarot-guide__link" href="${escapeHtml(guide.route)}" aria-label="${escapeHtml(accessibleTitle)}">${body}</a>` : body}</article>`;
    }).join("");
  }
